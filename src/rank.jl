export LowRankLDLTAlgorithm, ShiftCholesky, SVDCholesky
...
"""
    SVDCholesky <: LowRankLDLTAlgorithm

Use SVD decomposition.
"""
struct SVDCholesky <: LowRankLDLTAlgorithm end

"""
    MultivariateMoments.low_rank_cholesky(Q::AbstractMatrix, dec::LowRankLDLTAlgorithm, ranktol)
...
"""
    recommended_rtol(chol::LowRankLDLT)
...
"""
function recommended_rtol(chol::LowRankLDLT)
    r = size(chol.L, 2)
    first_dropped = min(lastindex(chol.singular_values), r + 1)
