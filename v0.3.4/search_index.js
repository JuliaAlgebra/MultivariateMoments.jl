...
{
    "location": "moments/#MultivariateMoments.moment_value",
    "page": "Moments and expectation",
    "title": "MultivariateMoments.moment_value",
    "category": "function",
    "text": "moment_value(m::AbstractMomentLike)\n\nReturns the value of the moment m.\n\nExamples\n\nCalling moment_value(moment(3.1, x*y^2)) should return 3.1.\n\n\n\n\n\n"
},

{
    "location": "moments/#MultivariatePolynomials.monomial-Tuple{MultivariateMoments.Moment}",
    "page": "Moments and expectation",
